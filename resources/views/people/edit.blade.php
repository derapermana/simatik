...
<form class="form form-horizontal" method="post" action="{{ \Request::url() }}">
    <div class="form-body">
        ...
        <div class="form-group {{ $errors->has('jabatan') ? ' has-error' : '' }}">
        	...
        	<div class="col-md-4">
        		<input type="text" class="form-control" name="jabatan" id="jabatan" value="{{ Input::old('jabatan', $item->jabatan) }}" required>
        ...
        <div class="form-group {{ $errors->has('nip') ? ' has-error' : '' }}">
        	...
        	<div class="col-md-4">
        		<input type="text" class="form-control" name="nip" id="nip" value="{{ Input::old('nip', $item->nip) }}">
                @if ($errors->has('nip'))
                    <span class="help-block">
        ...
        <div class="form-group {{ $errors->has('expertises') ? ' has-error' : '' }}">
        	...
        	<div class="col-md-4">
                <input type="text" class="form-control" name="expertises" id="expertises" value="{{ Input::old('expertises', $item->expertises) }}" data-role="tagsinput">
                <span class="help-block">
