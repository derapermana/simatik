...
<form class="form form-horizontal" method="post" action="{{ \Request::url() }}">
    <div class="form-body">
        ...
        <div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
        	...
        	<div class="col-md-4">
                <input type="text" class="form-control" name="type" id="type" value="{{ Input::old('type', $item->type) }}" required>
                @if ($errors->has('type'))
        ...
        <div class="form-group {{ $errors->has('enduser_name') ? ' has-error' : '' }}">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="enduser_name" id="enduser_name" value="{{ Input::old('enduser_name', $item->enduser_name) }}">
        ...
        <div class="form-group {{ $errors->has('active_term') ? ' has-error' : '' }}">
            ...
            <div class="col-md-4">
                <input data-provide="datepicker" class="form-control datepicker" data-date-format="yyyy-mm-dd" name="active_term" id="active_term" value="{{ Input::old('active_term', $item->active_term) }}">
        ...
        <div class="form-group {{ $errors->has('end_term') ? ' has-error' : '' }}">
            ...
            <div class="col-md-4">
                <input data-provide="datepicker" class="form-control datepicker" data-date-format="yyyy-mm-dd" name="end_term" id="end_term" value="{{ Input::old('end_term', $item->end_term) }}">
        ...
        <div class="form-group {{ $errors->has('qty') ? ' has-error' : '' }}">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="qty" id="qty" value="{{ Input::old('qty', $item->qty) }}">
                @if ($errors->has('qty'))
                    <span class="help-block">
        ...
        <div class="form-group {{ $errors->has('sku') ? ' has-error' : '' }}">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="sku" id="sku" value="{{ Input::old('sku', $item->sku) }}">
                @if ($errors->has('sku'))
                    <span class="help-block">
