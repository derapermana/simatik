    ...
    <form class="form form-horizontal" method="post" action="{{ \Request::url() }}">
        <div class="form-body">
            ...
            <div class="form-group {{ $errors->has('ip_address') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4">
                    {{--<select name="ip_address_id" class="form-control" id="ip_address_id">--}}
                        ...
                        {{--@endforeach--}}
                    {{--</select>--}}
                    <input type="text" name="ip_address" value="{{ Input::old('ip_address', $item->ip_address) }}" class="form-control">
            ...
            <div class="form-group {{ $errors->has('environment') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4">
                    <select name="environment" class="form-control" id="environment" required>
            ...
            <div class="form-group {{ $errors->has('technologies') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" name="technologies" id="technologies" value="{{ Input::old('technologies', $item->technologies) }}" data-role="tagsinput">
                    <span class="help-block">
                    <strong>Bahasa pemrograman, database, sistem operasi dll. Gunakan tanda ","(koma) untuk mengisi lebih dari satu</strong>
                </span>
            ...
            <div class="form-group {{ $errors->has('isactive') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4">
                    <select name="isactive" class="form-control" id="isactive" required>
